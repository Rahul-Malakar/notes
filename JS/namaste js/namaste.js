...
// var allows overwriting, let doesn't allow it give error
// const has all the awesome features that let has, with the added bonus that variables declared using const are read-only. Once a variable is assigned with const, it cannot be reassigned. Will show error if reassigned.
